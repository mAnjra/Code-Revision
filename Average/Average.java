...
public class Average implements Serializable{
	...
	public static void main (String args[]){
        ...
        try {
            ...
            System.out.println("Please enter your fat fucking weight:");
            weight.add(scan.nextInt());
            outputStream.writeObject(weight);
            outputStream.close();
            }   
            System.out.println("Do you want to add more flab? Yes/No");
            String answer = scan.next();

            if(answer.equals("No") || answer.equals("no")){
                System.out.println("----------------------------");
                System.out.println("Ok you fat bitch");
                System.out.println("Here are the previous weights: " + weight.toString());
                scan.close();
                fileOutput.close();
                break;
            }else{
                System.out.println("Ohh fatty wants to add more");
            }
            }
        } catch (IOException e) {
                e.printStackTrace();
